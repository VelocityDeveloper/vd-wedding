 ...
 * @class vdwdbutton
 */
class vdwdbutton extends FLBuilderModule
{
    ...
    public function __construct()
    {
        parent::__construct(array(
            'name'              => __('Button Action', 'fl-builder'),
     ...
     */
    public function get_classname($class = null)
    {
        $classname = 'vdwd-button fl-button-wrap';
        ...
        if (!empty($this->settings->click_action)) {
            $classname .= ' vdbb-button-action-' . $this->settings->click_action;
        }
        if (!empty($class)) {
            $classname .= ' ' . $class;
        }
 ...
 */
FLBuilder::register_module('vdwdbutton', array(
    'general'      => array(
        ...
        'sections'      => array(
            'general'    => array(
                ...
                'fields'        => array(
                    ...
                    'click_action'   => array(
                        ...
                        'default' => 'link',
                        'options' => array(
                            'play'     => __('Buka Undangan', 'fl-builder'),
                            'calendar' => __('Google Calendar', 'fl-builder'),
                        ),
                        'toggle'  => array(
                            'play'     => array(
                                'sections' => array('audio'),
                            ),
                            'calendar' => array(
                                'sections' => array('calendar'),
                            ),
                        ),
                        'preview' => array(
                            'type' => 'none',
            ...
            'audio' => array(
                'title'  => __('Audio Content', 'fl-builder'),
                'fields' => array(
                    'link_audio' => array(
                        'type'          => 'link',
                        'label'         => __('Link Audio', 'fl-builder')
                    ),
                    'id_targetaudio' => array(
                        'type'          => 'text',
                        'label'         => __('ID Link target', 'fl-builder')
                    ),
                )
            ),
            'calendar' => array(
                'title'  => __('Google Calendar', 'fl-builder'),
                'fields' => array(
                    'text_calendar' => array(
                        'type'          => 'textarea',
                        'label'         => __('Text', 'fl-builder')
                    ),
                    'location_calendar' => array(
                        'type'          => 'text',
